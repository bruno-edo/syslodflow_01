...
/**
 * Implementa&ccedil;&atilde;o de <code>Converter</code> que suporta diretamente classes de persist&ecirc;ncia.
 * @author carloshp
 * (c)2014-2015 COMDAT Ltda. Todos os direitos reservados.
 */
@FacesConverter(forClass = AbstractEntity.class, value = "abstractEntityConverter")
public class AbstractEntityConverter implements Converter {
